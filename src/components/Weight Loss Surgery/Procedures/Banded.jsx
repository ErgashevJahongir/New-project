            ...
            <div>
                ...
                <div>
                    ...
                    <Paragraph>
                        ...
                        adding band to a gastric bypass surgery is that the
                        pouch and the stoma sizes are important in the{' '}
                        <BlueLink
                            className="link"
                    ...
                    <Paragraph>
                        In the banded GBP (Gastric By-Pass) the pouch and the
                        stoma sizes are calibrated, standardized and reinforced.
                        There is even evidence that the band in the GBP also
                        results in less incidence of – outlet stenosis requiring
                        dilatation, dumping syndrome and reactive hypoglycemia.
                    </Paragraph>
                    <BandedFlex>
                        <img
                    ...
                    <BigText>
                        ...
                        adding the Fobi’s Ring or MiniMizer Ring or Midcal Ring
                        to it.
                    </BigText>
                </div>
            </div>
