        ...
        <RightContent>
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        <Paragraph>
                            After gastric bypass procedure, most of the patients
                            are expected to lose about 60-80% of their excess
                            body weight. This weight loss occurs within 9-12
                            months post-surgery, although some weight regain is
                            normal after 2-5 years in some of the patients.
                        </Paragraph>
                        <Paragraph>
                            Apart from weight loss, bariatric surgery is found
                            to have beneficial effects on a large number of
                            associated medical problems such as type II
                            diabetes, high blood pressure, acid reflux,
                            Obstructive sleep apnea, polycystic ovarian disease,
                            joint pains, stress incontinence. There are
                            improvements in psychosocial and depressive
                            disorders following bariatric surgery. Best of the
                            bariatric surgical centers like Cleveland clinic
                            have time and again shown about 80% of remission
                            from diabetes after bariatric surgery.
                        </Paragraph>
                        <Paragraph>
                            Patients are able to perform their routine
                            activities and duties easily and happily as there is
                            considerable mood elevation. Daily activities like
                            getting in and out of a car, walking in the garden,
                            shopping for clothes which they were not able to do
                            previously can be done with much ease after
                            bariatric surgery.
                        </Paragraph>
                    </div>
                </div>
                ...
                <div className="oview-sec-para pd-top">
                    <Paragraph>
